...
class Settings(tk.Frame):
	def __init__(self, master):
		...
		self.master.title("Tkinter Tab Controls")
		self.master.minsize(640, 400)

		#tabControl = ttk.Notebook(self)
		self.tab1 = ttk.Frame(self.tabControl)
		self.tabControl.add(self.tab1, text="Port Settings")
		self.tab2 = ttk.Frame(self.tabControl)
		self.tabControl.add(self.tab2, text="User Settings")
		self.tab3 = ttk.Frame(self.tabControl)
		self.tabControl.add(self.tab3, text="Extra Settings")
