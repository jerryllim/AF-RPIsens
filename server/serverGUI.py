...
class DisplayTable(QtWidgets.QWidget):
    ...
    def __init__(self, parent, database_manager, populate_shortcut='Return'):
        ...
        self.start_spin = QtWidgets.QTimeEdit(QtCore.QTime(8, 0))
    ...
    def update_table(self):
        ...
        if now.hour >= 20 or now.hour < 8:
            self.start_spin.setTime(QtCore.QTime(20, 0))
        else:
            self.start_spin.setTime(QtCore.QTime(8, 0))
        self.hour_spin.setValue(12)
...
class SFUDisplayTable(QtWidgets.QWidget):
    ...
    def __init__(self, parent, database_manager):
        ...
        self.end_spin = QtWidgets.QTimeEdit(QtCore.QTime(20, 0))
...
class MUDisplayTable(QtWidgets.QWidget):
    ...
    def __init__(self, parent, database_manager):
        ...
        start_datetime.setTime(QtCore.QTime(8, 0))
        ...
        end_datetime.setTime(QtCore.QTime(20, 0))
